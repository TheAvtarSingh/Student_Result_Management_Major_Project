...
const AddStudentAdmin = async (e)=>{
  ...
  fetch("http://localhost:5000/api/registerStudent",
  {
    ...
    body:JSON.stringify({
      StudentName : credentials.StudentName,RollNumber:credentials.RollNumber,
      Email:credentials.Email,
      Password:credentials.Password,
      Field:Field,
      Department:Department,
      Class:Class,
      Marks:{Physics:credentials.PhysicsMarks,
...
const [credentials, setcredentials] = useState({StudentName:"",Email:"",RollNumber:"",Password:"",Field:"",Department:"",Class:"",PhysicsMarks:"",ChemistryMarks:"",MathsMarks:""})
...
/*   const [PhysicsMarks, setPhysicsMarks] = useState("");
  ...
  const Bsc = ["Choose Department","Computer", "Physics", "Chemistry", "Maths"];
  ...
  // Fields For Class
  const CSE = ["Choose Class","FSA", "FSB", "AI-A", "AI-B", "AI-C", "CS-A", "DS-A", "DS-B"];
      ...
      <div className="d-flex flex-row justify-content-around">
        ...
        <div className="p-2">
          <form className="mt-5 m-5" method="post" onSubmit={AddStudentAdmin}>
            ...
            <p className="text-danger d-inline "> Note : All Fields are Maindatory (*)</p><br />
            <div className="mt-3">
            ...
            <p className="mb-4 me-5 ms-4 d-inline">


            </p>
            <Link to="/admin_dashboard" className="btn btn-primary btn-block mb-4 px-4 ms-5"> Go Back</Link>
